...
$title = 'Información sobre Gamificación Basada en Roles';
$pagetitle = $title;
$PAGE->set_pagelayout('standard');
$url = new moodle_url('/blocks/gamification/information.php');
$PAGE->set_url($url);
...
$data->information_owl = get_string('information_owl', 'block_gamification');
$data->information_lion = get_string('information_lion', 'block_gamification');
$data->information_wolf = get_string('information_wolf', 'block_gamification');
$data->information_eagle = get_string('information_eagle', 'block_gamification');
$data->information_koala = get_string('information_koala', 'block_gamification');
$renderable = new information_page($data);
